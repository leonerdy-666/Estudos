...
Esquema do Cenário:
	...
	Quando preencho os filtro numero da licitação "<numeroLicitacao>", ano da licitação "<anoLicitacao>", seleciono o combo modalidade, numero do processo adminsitrativo "<numeroProcessoADM>" e ano do processo administrativo "<anoProcessoADM>" e clico em buscar e alterar
	...
	E preencho os campos n do precesso administrativo "<numeroProcessoADM>" e ano do processo administrativo "<anoProcessoADM>" para alteração
...
Exemplos: 
	|numeroLicitacao|anoLicitacao|numeroProcessoADM|anoProcessoADM|numeroProcessoADM|anoProcessoADM|numeroAtaRegistro|nomeOrgãoRegistro|numeroLicitação|validadeMeses|valorEstimadoLicitacao|objetoLicitacao|justificativaContratacao|descrevaLote|quantidade|unidade|numeroEdital|mensagem                       |
  |01             |2020        |01               |2020          |01               |2020          |01               |teste            |01             |12           |1500                  |TESTE          |TESTE                   |TESTE       |1500      |unidade|0000008     |Licitação alterada com sucesso.|
