...
Esquema do Cenário:
	...
	E preencho o campo codigo licitação "<codigoLicitacao>" n processo administrativo "<nProcessoADM>", ano do processo administrativo "<anoProcessoADM>", n da licitação "<nLicitacao>", ano da licitação "<anoLicitacao>"
...
Exemplos:
	|codigoLicitacao|nProcessoADM|anoProcessoADM|nLicitacao|anoLicitacao|valorTotalEstimado|descrevaObjetoLicitacao|justificativaContratacao|descrevaLote|quantidade|unidade|numeroEdital|numeroDocumento|nomeRazao|numeroDocumento|nomeRazaoSocial|mensagem                       |
	|2020123456789  |01          |2020          |01        |2020        |1500              |TESTE									 |TESTE                   |TESTE       |1500      |UNIDADE|0000000007  |55282912082    |TESTE		 |46610141037    |TESTE	         |Licitação alterada com sucesso.|
